...
ships it leaves this file entirely: its behaviour goes to the spec for its own
discipline — [world-sim/](world-sim/README.md),
[game-design/](game-design/README.md) or another — and its delivery to
[ROADMAP.md](ROADMAP.md). A shipped feature lingering in a deferred list is how
a scope guard turns into misinformation.

The reasoning behind the load-bearing calls lives in [adr/](engineering/adr/README.md); this
...
- **Browser-honest budgets.** The targets are chosen to be met on a laptop, not
  ...
  [ADR-0010](engineering/adr/0010-map-size-is-capped.md). The figures themselves are in
