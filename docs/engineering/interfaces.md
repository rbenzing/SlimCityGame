...
| `readPaint`           | `(x, z) => { color, axis, from, to, tris }[]`         | the continuous bands a tile actually lays, measured off the chunk's vertex buffer — how wide the asphalt and paint came out, not how wide the section says they are |
