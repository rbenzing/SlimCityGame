...
[SPEC.md](../SPEC.md); if you want to know _why it is that way and what else was
...
alongside a rule the code must obey, the rule belongs in SPEC.md and the record
